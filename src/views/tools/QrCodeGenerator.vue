    ...
    <div class="w-full max-w-4xl bg-white rounded-2xl shadow-xl p-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="bg-gray-50 rounded-xl p-6 h-full flex flex-col items-center justify-center">
            <h2 class="text-xl font-semibold text-gray-800 mb-6">二维码预览</h2>
            <div v-if="qrValue" class="flex flex-col items-center space-y-4">
              <VueQrcode :value="qrValue" :size="220" level="M" class="shadow-lg rounded-lg bg-white p-4" />
