      ...
      <v-row class="h-full ma-0">
        ...
        <v-col cols="7" class="h-full d-flex align-center justify-center position-relative">
          <div class="position-relative text-center px-16">
            ...
            <p class="text-h5 text-white font-weight-regular">您的在线工具箱，为开发提供便利</p>
        ...
        <v-col cols="5" class="h-full d-flex align-center justify-center">
          <v-card class="auth-card elevation-24">
            <div class="text-center mb-12">
              <h2 class="text-h3 font-weight-bold mb-4" style="background: linear-gradient(135deg, #0062ff, #00b7ff); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">欢迎回来</h2>
              <p class="text-subtitle-1 text-medium-emphasis">登录您的账号以继续</p>
            </div>
            ...
            <v-form v-model="formValid" @submit.prevent="handleLogin">
              ...
              <div class="text-center">
                ...
                >
                  <span class="text-primary font-weight-medium">还没有账号？立即注册</span>
                </router-link>
              </div>
            </v-form>
...
async function handleLogin() {
  try {
    ...
    if (response?.token) {
      ...
      router.push(redirect || '/tools/case-converter')
    }
  } catch (err) {
